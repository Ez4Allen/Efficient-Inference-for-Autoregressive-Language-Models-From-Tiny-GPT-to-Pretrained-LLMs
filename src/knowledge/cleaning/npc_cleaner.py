...
DEFAULT_INPUT_PATH = (
    TERRARIA_CATALOG_ROOT / "normalized" / "NPCs.jsonl"
)

DEFAULT_OUTPUT_PATH = TERRARIA_CLEANED_ROOT / "NPCs.jsonl"

DEFAULT_REPORT_PATH = TERRARIA_CLEANED_ROOT / "NPCs_report.json"
